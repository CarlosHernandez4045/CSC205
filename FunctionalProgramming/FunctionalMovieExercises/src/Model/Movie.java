...
public class Movie {
    ...
    private static final List<Movie> movieList = new ArrayList<>(Arrays.asList(
        ...
        new Movie("Jurassic Park", new BigDecimal("7.25")),
        new Movie("007: Tomorrow Never Dies", new BigDecimal("6.50")),
