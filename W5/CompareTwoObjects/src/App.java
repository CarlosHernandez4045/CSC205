...
public class App {
    public static void main(String[]  args){
        ...
        sortObjectsAlphabeticallyUsingComparable(); //new method I made to use the code base in order to sort the cars alphabetically using the Car class itself!
    }

    //new method to directly sort Car objects alphabetically
    public static void sortObjectsAlphabeticallyUsingComparable() {
        var car1 = new Car("GM", 6778678.00D);
        var car2 = new Car("Xenon", 898990.00D);
        ...
        //Collections.sort uses compareTo and since we override that, it should alphabetically sort our list
        Collections.sort(carList);

        System.out.println("-------------------------");
        System.out.println("Sorted List of Cars Alphabetically:");
        for (Car car : carList) {
            System.out.println(car);
        }
    }
    ...
    public static void testObjectDataTypeCompare() {
        ...
        // README: if you uncomment the code below and see that you cannot do what the code is trying to do
        // So the questions is how you want to compare two objects. This concept is very important
        // if( car1 > car2){
